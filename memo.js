...
arr.spliсe(index, count, elem)    /* удалить count эл-ов, начиная с index
...
arr.indexOf() // возвращает первый индекс, по которому данный эл.может быть найден в массиве или -1, если такого индекса нет.
