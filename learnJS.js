...
let num3 = 255;
console.log(num3.toString(2)); // вернёт число 255 в 2-чной системе исчисления
console.log(num3.toString(8)); // вернёт число 255 в 8-чной системе исчисления
console.log(num3.toString(16)); // вернёт число 255 в 16-чной системе исчисления
